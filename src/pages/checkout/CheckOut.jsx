        ...
        <div className="checkOutRight">
          ...
          <div className="checkOutDeliveryDetails">
            ...
            <div className="checkoutDeliveryData">
              ...
              <input type="text" placeholder="" value={pickupLocation} onChange={handlePickupLocationChange} required />
            </div>
            <div className="checkoutDeliveryData">
              <span>Directions</span>
              <input type="text" placeholder="Area/Estate/Street/Market/Landmark" value={direction} onChange={handleDirectionChange} required />
            </div>
            <div className="checkoutDeliveryData">
